				...
				<div class="card-body bg-light">
					...
					<form method="post">
						<div class="form-group">
							<label for="nom">Type du crédit</label>
						...
						<div class="form-group">
							<label for="revenum">Total des revenus mensuels</label>
							<input type="text" name="revenum" class="form-control"  required>
						</div>
						<div class="form-group">
							<label for="chargesm">Total des charges mensuelles</label>
							<input type="text" name="chargesm" class="form-control" required>
						</div>
